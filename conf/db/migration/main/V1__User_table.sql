...
CREATE TABLE "TimeTable" (
  id SERIAL NOT NULL PRIMARY KEY,
  hostId INTEGER NOT NULL REFERENCES "User" (id) ON UPDATE RESTRICT ON DELETE RESTRICT,
  visitorId INTEGER NOT NULL REFERENCES "User" (id) ON UPDATE RESTRICT ON DELETE RESTRICT,
